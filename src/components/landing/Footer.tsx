    ...
    <footer className="py-12 px-6 bg-slate-50 border-t border-slate-200">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-slate-900 tracking-tight uppercase">ENOLA.AI</span>
        </div>
        ...
        <div className="text-sm text-slate-400">&copy; 2026 ENOLA.AI. All rights reserved.</div>
      </div>
    </footer>
  );
}
